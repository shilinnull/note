...
> Func1 执行的基本操作次数 ：  
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742780981570-a348bb32-9751-499d-8373-b6109ec0d7d1.png)
>
> + N = 10 F(N) = 130
> + N = 100 F(N) = 10210
> + N = 1000 F(N) = 1002010
...
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742781113591-4b612c8f-8dd0-4b62-984a-93c651566136.png)



> 使用大O的渐进表示法以后，Func1的时间复杂度为：![image](./算法的时间复杂度和空间复杂度以及OJ练习.assets/bbf56443ea1329da29deade31b382f38.svg)
>
> + N = 10 F(N) = 100
> + N = 100 F(N) = 10000
> + N = 1000 F(N) = 1000000
...
+ 这是C语言库里面的一个函数[strchr](https://legacy.cplusplus.com/reference/cstring/strchr/?kw=strchr)，是定位字符串中出现的第一个字符
...
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742781277819-8e56ecee-80df-46a9-a94f-42fb2737195a.png)

+ 再来看第二个 `PartSort1`，当`left`和`right`相遇时，时间复杂度是`O(N)`

![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742781280313-ff99c0c3-c275-411d-b04d-dfb2695f74b6.png)
...
![image](./算法的时间复杂度和空间复杂度以及OJ练习.assets/47ad73db8ba38d59f72333bf3b7de48e.svg)
...
**比如：**  
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742781491422-2ba663b9-58ee-447b-b289-e88a9037a199.png)
...
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742781569916-4a0f596d-7fee-4c39-b604-5da6c1dcd4ae.png)

+ 这里可以用到错位相减法，如图：

![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742781586623-7c9d9256-0529-471a-8bd8-f85b9f263790.png)
...
+ `空间复杂度算的是变量的个数`，对一个算法在运行过程中临时`额外`占用存储空间，有没有开辟临时的空间？有！
+ 它们都是常数个，所以就是`O(1)`
...
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742782157129-e3afa99f-cec5-4e5b-9596-6d35d2bb21ca.png)
...
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742782265976-8eb59e1a-9057-488e-9092-92b7bb3a750d.png)
...
![](./算法的时间复杂度和空间复杂度以及OJ练习.assets/1742782271424-6b963cba-4992-4089-a661-c7acf7e8717c.png)
