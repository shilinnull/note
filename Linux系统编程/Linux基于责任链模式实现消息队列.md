...
![image-20260210143919527](./Linux基于责任链模式实现消息队列.assets/image-20260210143919527.png)
...
+ msgflg：控制着当前消息队列满或到达系统上限时将要发生的事情, 0即可（ msgflg=IPC_NOWAIT 表示队列满不等待，返回EAGAIN错误 ）。
...
![1](./Linux基于责任链模式实现消息队列.assets/1.png)
