...
![](./IO流操作.assets/file-20251116204613053.png)

## IO流状态
IO操作的过程中，可能会发生各种错误，IO流对象中给了四种状态标识错误：

![](./IO流操作.assets/file-20251116204613016.png)
...
![](./IO流操作.assets/file-20251116204613015.png)
...
![](./IO流操作.assets/file-20251116204613008.png)
...
![](./IO流操作.assets/file-20251116204613023.png)

+ 当把这里的`char _address[32]`换成`string`

![](./IO流操作.assets/file-20251116204613044.png)

+ 代码就显示异常退出了，这里是因为同一个进程写和读是有**浅拷贝**的风险

![](./IO流操作.assets/file-20251116204613052.png)

+ 一个进程读，过一会一个进程写，会出现野指针访问

![](./IO流操作.assets/file-20251116204613030.png)
...
![](./IO流操作.assets/file-20251116204613038.png)
