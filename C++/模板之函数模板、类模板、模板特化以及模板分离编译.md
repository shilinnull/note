...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583185542-335582d8-bef2-448d-84f6-27236849430b.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583184800-8e713d04-ea99-4370-8914-e6343e52f3a9.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583184994-a7b85775-1396-4606-bf32-00cad856f2a5.png)
...
3. 模板函数**不允许自动类型转换**，但**普通函数可以进行自动类型转换**。

## 2.6 使用typename进行前置声明
```cpp
...
1. **类型形参**： 出现在模板参数列表中，跟在`class`或`typename`关键字之后的参数类型名称。
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583184979-0825d677-631c-43cc-9abe-3216ad72f3eb.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1744543906325-c5910a07-d904-4aec-a9d5-afb8382b47d2.png)

越界读写都会检查，这里的数组是在**栈上开辟的，开辟过大还会导致栈溢出**
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583184981-7e9b861c-84a7-4d13-ae0b-77681bcc23ae.png)

## 5.1 按需实例化
+ 我们这里明显是一个语法错误，但是编译器检查不出来

![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583185428-027c5437-db59-4779-b98b-5b954f3e0cfd.png)

+ 这里是因为**实例化这个类的时候，会按需实例化（调用哪个成员函数就实例化哪个）**
+ `根据模板实例化-->半成品模板-->实例化成具体的类/函数-->语法编译`

![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583185549-3ed8677a-fe58-4dbe-a235-dde19435560a.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583185501-e65a6abc-81b2-46b3-a0c4-c45548d90ae5.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583185745-0daf8644-76c5-4c87-bc20-79f5940aa76c.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583186049-395a857d-f26f-4408-a00d-b81c37e71f64.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583186075-581d0f32-395b-4112-a3ae-19305fffc370.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583186164-a8517435-ba49-41b2-ab75-0cb726a2f110.png)
...
![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583186213-a1b05614-9121-4c8d-a17d-7252f88c2ec5.png)

**分析：**

![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583186420-21b6f9f6-db6c-4781-aa7a-349a539fce08.png)

+ 可以将实现放到`xxx.h`，就不会链接错误了

![](./模板之函数模板、类模板、模板特化以及模板分离编译.assets/1743583186828-2cc35bc0-95a5-4f59-9a15-12078bf90b4b.png)
