...
![](./二叉搜索树介绍以及实现.assets/1745116665370-d896a0e0-9d05-4946-bda3-8f2f7d4da43f.png)

### 二叉搜索树操作
![](./二叉搜索树介绍以及实现.assets/1745138110661-029dd8de-7b54-4191-ae91-91cbc4f7329d.png)
...
![](./二叉搜索树介绍以及实现.assets/1745116665351-109cbd53-00e8-4ce5-bb83-3be298d310b1.png)
...
![](./二叉搜索树介绍以及实现.assets/1745116665448-ab4271e8-64b9-417b-ba42-d1f39522db98.png)
...
![](./二叉搜索树介绍以及实现.assets/1745116665510-b58824f3-9582-4eb1-880d-04a74b62122a.png)
...
![](./二叉搜索树介绍以及实现.assets/1745116665740-5fffc5ea-2440-449d-907c-ee3c43121db2.png)
...
![](./二叉搜索树介绍以及实现.assets/1745116665826-74d2d625-25ea-4611-985b-5646e0c00fc4.png)
...
![](./二叉搜索树介绍以及实现.assets/1745116665903-dea00fb6-46c6-4ad8-9bed-0eee86b76abf.png)

+ 最优情况下，二叉搜索树为完全二叉树(或者接近完全二叉树)，其平均比较次数为：![image](./二叉搜索树介绍以及实现.assets/7e644f2e8568b4d6301418088a957cef.svg)
+ 最差情况下，二叉搜索树退化为单支树(或者类似单支)，其平均比较次数为：![image](./二叉搜索树介绍以及实现.assets/23b1aa27b1426f8b29c228ddc0ec9d85.svg)
...
1. **K模型**：K模型即只有key作为关键码，结构中只需要存储Key即可，关键码即为需要搜索到的值。
    1. 比如：给一个单词`word`，判断该单词是否拼写正确，具体方式如下：
    2. 以词库中所有单词集合中的每个单词作为key，构建一棵二叉搜索树
    3. 在二叉搜索树中检索该单词是否存在，存在则拼写正确，不存在则拼写错误。
