...
![](./类型转换.assets/file-20251116204604538.png)
...
![](./类型转换.assets/file-20251116204604525.png)
...
![](./类型转换.assets/file-20251116204604587.png)
...
![](./类型转换.assets/file-20251116204604566.png)

+ 然而加上了`volatile`后，值一样了，但是a的地址又不一样了，这里可能是流插入的运算符捣的鬼，在匹配的时候匹配错了

![](./类型转换.assets/file-20251116204604573.png)

+ 那么我分别使用C语言的`printf`和`cout`打印也是正常的：

![](./类型转换.assets/file-20251116204604579.png)

+ 在Linux平台下也是如此：

![](./类型转换.assets/file-20251116204604545.png)

![](./类型转换.assets/file-20251116204604552.png)
...
![](./类型转换.assets/file-20251116204604532.png)

![](./类型转换.assets/file-20251116204604559.png)
...
![](./类型转换.assets/file-20251116204604503.png)
...
![](./类型转换.assets/file-20251116204604517.png)
...
![](./类型转换.assets/file-20251116204604510.png)

如果不是继承关系，**会抛bad_typeid异常。**

![](./类型转换.assets/file-20251116204604494.png)
