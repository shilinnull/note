...
![](./内存管理学习【new】.assets/1758272162049-80238c7d-f578-436b-bf1e-781ddc843b00.png)
...
+ 为什么要分这些区域
    - 为了**方便管理**，程序中有各种不同的数据
+ 这些区域哪个区域是我们需要重点关注的？ 
    - **<font style="color:#DF2A3F;background-color:#FBDE28;">堆</font>**【堆留给我们自己自主控制的】
...
![](./内存管理学习【new】.assets/1743582962585-e4cebd50-2d83-4ad4-9c65-5037b3c8228e.png)

![](./内存管理学习【new】.assets/1743582962611-32c92fd5-4855-4da0-9185-614036d5d0e0.png)
...
![](./内存管理学习【new】.assets/1743582962649-580b92bf-67d7-4c1d-b945-f454ef18c185.png)
...
![](./内存管理学习【new】.assets/1743582962597-c271214a-a56f-4b0a-9b2b-51fb37640c26.png)

小结：**在申请自定义类型的空间时，new会调用构造函数，delete会调用析构函数，而malloc与free不会。**

+ 在我们使用malloc的时候，都需要手动检查，而**new失败了就会抛异常**
...
![](./内存管理学习【new】.assets/1743582963069-d1b91a99-d972-459b-93d5-b1e71e38f6e4.png)

![](./内存管理学习【new】.assets/1743582963273-bf297298-9955-421a-a3b6-9d28dac83574.png)

![](./内存管理学习【new】.assets/1743582963163-67385366-9694-4a72-a28b-73c0921d4082.png)
...
![](./内存管理学习【new】.assets/1743582963161-5a0863af-02f9-436f-b456-9b3f81ae0c72.png)

+ 通过内存监视窗口再看一下

![](./内存管理学习【new】.assets/1743582963319-de3353f3-3d11-4adb-9076-a200ce076b5f.png)

+ 如果不显示写这个析构函数，就也不会多开4个字节，编译器会自动生成一个，编译器觉得什么也不干，自动就会优化掉了，也就不会调用了
+ 而内置类型就不会多开，内置类型就不用调用析构函数

![](./内存管理学习【new】.assets/1743582963558-1d280883-dec0-4b89-b1b8-ad728bdacfee.png)
...
## 七、常见面试题
**<font style="color:#DF2A3F;background-color:#FBDE28;">malloc/free和new/delete的区别</font>**
