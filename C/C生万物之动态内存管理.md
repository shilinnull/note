...
![](./C生万物之动态内存管理.assets/1740109421881-a9d4bb57-3b3e-41fa-b56d-e4dc2b54fe8f.png)
...
![](./C生万物之动态内存管理.assets/1740109468266-f45df42c-51db-4d3b-a8c2-fef3782b5e84.png)
...
![](./C生万物之动态内存管理.assets/1740109470821-ca65fde7-f295-4ab9-bced-9c835e4f423b.png)
...
![](./C生万物之动态内存管理.assets/1740109471678-3b73349a-68d1-4c6e-a541-6c26261314e1.png)
...
![](./C生万物之动态内存管理.assets/1740109473248-3da94a7d-b8ea-4280-905a-fb8e723de7d2.png)
...
![](./C生万物之动态内存管理.assets/1740109475184-62b4c67f-f88a-48c5-a33e-6d9d2d5613ff.png)

+ 若是我们想化解这个危机的话，可以在`free(p)`之后再将其置为NULL即可，此时就无法再找到之前的那块地址了

![](./C生万物之动态内存管理.assets/1740109476362-33699405-65bc-44ec-ae50-900a63483cd5.png)
...
![](./C生万物之动态内存管理.assets/1740109478204-c06eaba0-5261-487b-acc2-77c01659e7c5.png)
...
![](./C生万物之动态内存管理.assets/1740109479681-59e6db67-fc9d-4411-bd82-3fbefca369ef.png)

+ 如果还是觉得有点不可思议的话，我们可以再通过内存去仔细看看

![](./C生万物之动态内存管理.assets/1740109480627-29a1b4fe-7627-467d-8c02-6fbf9bc083c0.png)
...
![](./C生万物之动态内存管理.assets/1740109482891-1f1a6772-fabc-4b55-9526-6f4842a28b30.png)
...
![](./C生万物之动态内存管理.assets/1740109484887-6f024152-9984-41ed-a22e-e0f14f0442dd.png)
...
![](./C生万物之动态内存管理.assets/1740109487305-3c24eeb0-1a35-42a9-884b-923c2152a911.jpeg)  
**改进：**
...
![](./C生万物之动态内存管理.assets/1740109489312-4980c99e-4613-42be-b0c6-038a66b627eb.png)
...
![](./C生万物之动态内存管理.assets/1740109490986-6f609940-e250-47b9-949b-4360bd136b2d.png)

+ 其实我们可以将`*(p + i) = 0`修改成`p[i] = 0`，利用`[]`操作符对某个下标进行访问，此时我们可以看到编译器就报出了警告说**索引"10"超出了“0"至”9"的有效范围**，因此合法的下标索引即为`0 ~ 9`

![](./C生万物之动态内存管理.assets/1740109492353-df8c1f4f-5533-4599-aa91-6db2fbf7ac6c.png)
...
![](./C生万物之动态内存管理.assets/1740109494035-b054c6f5-6550-4ebb-be83-497fd421723e.png)
...
![](./C生万物之动态内存管理.assets/1740109496131-20876643-8cd2-440c-92e8-ab2a6030e5a4.png)
...
![](./C生万物之动态内存管理.assets/1740109498412-cf482bdb-c63c-4918-ad94-84aa29f3c1ac.png)

+ 可以看到，此时若是去`free()`的话就会出现警告，很明显这个`debug_heap.cpp`就是【堆】这一块出的问题

![](./C生万物之动态内存管理.assets/1740109501491-1ba3c0a7-94ad-434e-bad9-386db982c6a1.png)
...
![](./C生万物之动态内存管理.assets/1740109505277-abe6a8d9-63c9-4f32-910a-21c1faaf8be9.png)
...
![](./C生万物之动态内存管理.assets/1740109508959-65d99caf-d8c4-4ec7-9ba1-12136efbbd9c.png)
...
![](./C生万物之动态内存管理.assets/1740109510527-6884d45b-bc3d-4ce2-ba79-feba0739c483.png)
...
![](./C生万物之动态内存管理.assets/1740109512412-6315b418-6f44-4212-b478-fb4b4d01b67a.png)
...
![](./C生万物之动态内存管理.assets/1740109514461-e1ee3099-5d96-40c8-8145-70bf6b763841.png)
...
![](./C生万物之动态内存管理.assets/1740109515844-ae1244ac-c39d-4f17-9a9b-0590594e5df4.png)
...
![](./C生万物之动态内存管理.assets/1740109517504-19471cd9-142c-4fa2-856c-56169b960089.png)
...
![](./C生万物之动态内存管理.assets/1740109521637-932ab3a1-6c99-4fae-84c2-21c2bcedb89d.png)

![](./C生万物之动态内存管理.assets/1740109522583-23fdcc6a-c199-4811-9a58-fd1f83898270.png)
...
![](./C生万物之动态内存管理.assets/1740109525552-1c714f99-28b6-42e0-9b9f-526d1c111873.png)
...
![](./C生万物之动态内存管理.assets/1740109527612-150aa8a3-f313-436d-baab-be6f22d847cf.png)
...
![](./C生万物之动态内存管理.assets/1740109531163-045cb6a6-2cf5-4b42-8eee-7662192619b1.png)
...
![](./C生万物之动态内存管理.assets/1740109534361-073b07a4-2316-42d6-ac77-448475a06c13.png)
...
![](./C生万物之动态内存管理.assets/1740109537042-c7a23b7f-f7a7-4f79-883b-af7628ef1632.png)
...
![](./C生万物之动态内存管理.assets/1740109539701-05a8531a-5b44-4e4e-9259-96fd74d1c195.png)

既然结构体的中的数组大小都增大了，那么这个结构体的大小会发生改变吗？

+ 不过通过观察我们可以发现其是不会发生变化的，因为在一开始讲柔性数组的时候我们就有说到过，无论数组的大小是多少，均是不算在结构体的大小内的
...
![](./C生万物之动态内存管理.assets/1740109542279-5e63dd50-3ae8-46a9-a27a-7cc5cee0f951.png)

+ 那此时这个结构体的内存分布就是下面这样的，有一个结构体指针指向了一块内存空间，里面存放了两个结构体成员，分别是`i`和`a`，其中后者是一个字符型指针，又指向了内存中的一块连续区域，它们都是在堆中的`malloc`出来的

![](./C生万物之动态内存管理.assets/1740109543595-b743e30f-4b13-4001-90f2-03e23f374ee8.png)
...
+ 连续的内存有益于提高访问速度，也有益于减少内存碎片，因为当前在多次`malloc`之后，内存中就会产生多个内存碎片，所以我们应该尽量减少`malloc`和`free`的此处。
