...
本篇博客就来进行讲解这个三子棋小游戏。（本文使用的编译器是`VS2022`）
...
+ 在我们写一些程序的时候就会遇到一个.c文件里写很多，会显得杂乱，可读性会变的非常差，那么我们就要使用份文件来写代码，这样就会变得条理清晰，可读性强，这样是一种良好的编程习惯。
...
![](./C语言之数组应用——三子棋小游戏.assets/1739181832872-7f5a82f8-f9dc-406a-9174-d041e121ad02.png)

## 二、框架搭建
+ 创建好文件后，将game.c和test.c引入game.h，头文件的包含和函数的声明就在这里面

![](./C语言之数组应用——三子棋小游戏.assets/1739181834628-8ff93da5-328e-46ed-9541-da64b628fc3a.png)

> 游戏界面：
>

![](./C语言之数组应用——三子棋小游戏.assets/1739181836067-a02d62c3-4dfa-4474-bed4-a38efbb30e85.png)
...
![](./C语言之数组应用——三子棋小游戏.assets/1739181839414-7fd42868-ab81-4bcb-a0b1-33d1fc86e647.png)
...
![](./C语言之数组应用——三子棋小游戏.assets/1739181841382-cafda0ce-aa19-42ab-ac2a-00696c4229f8.png)
