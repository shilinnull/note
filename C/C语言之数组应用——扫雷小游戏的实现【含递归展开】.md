...
![](./C语言之数组应用——扫雷小游戏的实现【含递归展开】.assets/1739181851555-7a65c2f3-fc6a-40da-bb02-3f5011400895.png)
>
...
![](./C语言之数组应用——扫雷小游戏的实现【含递归展开】.assets/1739181855670-da4c66db-a92b-46f7-956d-75d95972da06.png)
...
![](./C语言之数组应用——扫雷小游戏的实现【含递归展开】.assets/1739181861116-fbb4af09-df93-4a3d-87df-f1334c6fb1c2.png)
...
`row*col`个字符中有10个雷，只有当我们把所有不是雷的位置排查完，游戏才算赢，我们在while条件判断里面写`win < (row * col - EASY_COUNT)`作为输赢的条件；
