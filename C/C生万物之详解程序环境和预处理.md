...
![](./C生万物之详解程序环境和预处理.assets/1740110046004-15b7d214-14bd-4b47-ae67-d8db23452d00.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110050257-a430f1d0-47a7-42d8-b0ad-6782a0a6be22.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110051754-61ceb505-0b0d-4240-903f-69549d215222.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110054589-7841f3d4-4315-4b1c-bc89-4d05336a452a.png)

+ 接下去可以通过gcc编译一下【test.c】这个源文件

![](./C生万物之详解程序环境和预处理.assets/1740110055686-559c281b-18a5-4d9c-9c25-4bbc2c99d4fa.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110057032-f9140a4f-c8c6-489a-a5c9-acd4eaccd6a9.png)

+ 到这里就可以看到我们熟悉的`main`函数了

![](./C生万物之详解程序环境和预处理.assets/1740110057955-3b2f4845-3281-4f30-b2c4-4ab1f1b74aac.png)

+ 此时往上滑就可以看到这个预编译后的文件中有一堆的代码。其实这些代码都是头文件`stdio.h`中的内容，这里的【test.i】只是将这个头文件展开了而已

![](./C生万物之详解程序环境和预处理.assets/1740110059348-b22b246d-f1cf-408e-8ae4-2a4a5a325443.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110061400-58e136c7-377b-4357-8754-2bc62176ba0c.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110063221-4657c9b6-d052-4898-b965-4e4cf977a7d1.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110064820-7429c2c3-6b37-40c7-a338-e42ef48a216e.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110068214-55aa38c7-98a3-46f6-b27d-3132d3c971ea.png)

+ 其实对于之前生成过的【test】我们也可以进行一个浏览

![](./C生万物之详解程序环境和预处理.assets/1740110069421-77309b1e-3520-422a-b230-f392e5294db4.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110074279-470cc117-0fd5-4a24-a4af-c046a52f0198.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110076013-d1e5452d-6e2f-496d-803d-40a1cfe22eea.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110092989-71a1ef5d-ff49-4b59-bdb8-cffba9430bc5.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110096237-993b0026-96b4-40a6-8e32-ead8d66e3b3f.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110099283-a2f8a7d3-929e-48e2-bbe3-4e1004ca97f5.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110100504-77f38b07-c137-4178-977f-750a27a3efc6.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110102794-546e7d27-d3f3-44aa-b70e-687b03f612a1.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110103864-185b74ee-b0ea-4a3c-813b-ce1b407cc8d0.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110105609-eeba812e-ef98-4dd4-8de0-865d2169e9fe.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110107558-a45549f7-518f-4730-aec4-2ea2eabf334c.png)

+ 可以看到运行结果算出来并不是我们想要的100，而是在进行了宏替换之后运算出来为55
+ 我们通过查看一下【预编译】后的`test.i`文件来看看是如何进行宏替换的

![](./C生万物之详解程序环境和预处理.assets/1740110109274-6012223e-d96e-45dd-a825-3cdaeb4bb86b.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110112166-96401c65-2fdf-434d-b36c-236658e50f7a.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110114933-83eec28b-cfb9-4dc5-b139-6712208ed6ef.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110116590-3d844635-a0d0-42d0-b799-9f7316b02ad2.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110118244-b22206bc-3e9d-4fdb-b58b-421b49c81d8c.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110119972-1a029153-2f3e-47e3-97c7-c4e2fa539e93.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110122971-2dfc5fae-8628-4543-bc88-c0efdd89b258.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110124500-fc4bd3b8-bd94-4106-8872-23e83c4737eb.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110126878-7b93e11b-27f1-4b5d-9499-5474d3ae85d0.png)

+ 我们可以进入【预编译】阶段看看宏定义是如何替换的

![](./C生万物之详解程序环境和预处理.assets/1740110128273-1945239d-706a-43cf-81e4-9233dfc5f0be.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110130464-83582cb4-fe3c-4ff2-9a7f-30edf30622a1.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110131994-f03d7070-cd49-4a3f-b9c1-4ddcdd423926.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110135134-37636ed1-b9d9-4be1-8a32-916e55e4d607.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110137356-2b580213-dfaf-45db-84f1-ce2bb0723dff.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110140717-fceaef15-4538-4235-a661-5ee99106fd2f.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110144603-2c328201-434a-4920-b92c-066867c7f6ab.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110146726-172e6daf-c5e2-494b-b25f-8704239a21db.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110147848-3498c82f-77b4-4538-96cf-6eaf5aa1a21b.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110151128-56085154-16c8-460b-97da-5a44c913a026.png)
...
![](./C生万物之详解程序环境和预处理.assets/1740110153945-d07fcc9f-4373-4354-a45b-0a2bf2e68ddf.png)
