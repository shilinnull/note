...
![](./C生万物之文件操作.assets/1740109552974-f7e09b79-e96b-4bf8-b4ad-79581d81f4a2.png)
...
![](./C生万物之文件操作.assets/1740109556058-5971133d-fd0e-4ed6-adc2-b485e94a1daa.png)
...
![](./C生万物之文件操作.assets/1740109560604-e69a39d0-6f19-4bff-9ec5-49f5faccc0d1.png)
...
![](./C生万物之文件操作.assets/1740109563388-1cdaf907-10ce-48a5-aeeb-6affe242ad80.png)

![](./C生万物之文件操作.assets/1740109564587-ce14d7d0-342c-4e52-a020-3ac9cc7f77f2.png)
...
![](./C生万物之文件操作.assets/1740109566387-e5d0237a-426d-4338-8f81-7ed0127d2e41.png)

+ 既然能写一个，那也就可以写多个

![](./C生万物之文件操作.assets/1740109567940-5f5c9e2a-e7fc-4810-8640-e68e92199d5c.png)
...
![](./C生万物之文件操作.assets/1740109569206-a7198e40-049b-4424-8192-caf59c6ae7fe.png)
...
![](./C生万物之文件操作.assets/1740109570556-f959768a-3d19-4025-9135-ec453ffea3b5.png)
...
![](./C生万物之文件操作.assets/1740109572474-1471d460-0704-407a-a6ce-93cf2ad9f340.png)
...
![](./C生万物之文件操作.assets/1740109573749-2b546685-8aaf-40c3-a328-0df3de96adbe.png)

+ 但是呢，我们平常在读取文件中内容的时候，并不知道里面有什么东西，有多少东西，因此应该写一个通过的程序，才能适应更多的情况
+ 我们再仔细看看`fgetc`的简述。可以看到当它读到文件末尾的时候便会返回`EOF`，即**End Of File（文件结束）**

![](./C生万物之文件操作.assets/1740109575185-e4cf540d-c2fb-4018-a2fe-c3cd19a8cff3.png)
...
![](./C生万物之文件操作.assets/1740109576467-8fbb5253-ce84-47c7-a45d-33a084b87de6.png)
...
![](./C生万物之文件操作.assets/1740109578017-5e9a8552-51f5-4aae-b05b-ed572bf50b78.png)  
![](./C生万物之文件操作.assets/1740109579163-71955169-2e61-4686-9a52-f975dc7b8957.png)

+ 然后我们像向文件中写入一个字符串试试

![](./C生万物之文件操作.assets/1740109580468-59859006-00c5-4106-aa88-93efb7eade94.png)

+ 可以写东西进去了，接下去一样，将我们写的东西读出来试试
+ 可以看到在读取结束之后`DeBug`和显示窗口都可以看到只有四个字符，并没有5个，这是为什么呢？似乎是读到了一个换行符

![](./C生万物之文件操作.assets/1740109754293-9ea869d6-c9b4-4802-af6c-d61509559919.png)

我们再仔细地观察一个这个函数

![](./C生万物之文件操作.assets/1740109763565-99c41e6b-ea76-4374-ba88-a39545059242.png)
...
![](./C生万物之文件操作.assets/1740109774981-81793c9e-fda7-4a8c-8a07-3c56084df3b5.png)
...
![](./C生万物之文件操作.assets/1740109804071-75297b62-4d04-4ce6-a9ad-14137a368e21.png)  
![](./C生万物之文件操作.assets/1740109805216-8988f278-653b-4ec1-8f24-8188b6caf9a2.png)
...
![](./C生万物之文件操作.assets/1740109809725-b52a90c9-16c6-4cb7-9da4-89b8d0ac82bf.png)

还是一样也可以读出来打印

![](./C生万物之文件操作.assets/1740109810898-c5fc0c56-11c8-430d-be10-1cf9b02d6dc9.png)
...
![](./C生万物之文件操作.assets/1740109815488-ebb6b369-a4f1-47ad-8452-6be21f0b4218.png)

![](./C生万物之文件操作.assets/1740702612912-55a87915-f531-4d0b-b847-2f83a921f510.png)  
![](./C生万物之文件操作.assets/1740109819547-18285144-c6b5-4764-9c85-30cc9b40b6f2.png)

![](./C生万物之文件操作.assets/1740702630996-ec442e49-46cb-49ae-b4e9-b0ed62b0ed90.png)

+ 可以看到文件中是写入了一些数据，但是呢写进去的东西是乱码的样子，看不太懂

![](./C生万物之文件操作.assets/1740109820871-f33633ff-f2ec-4753-b813-17ee8d069bd6.png)

既然都是以二进值写的，那么我们也需要以二进值读  
可以看到，以二进值的方式读出来了  
![](./C生万物之文件操作.assets/1740109822790-ef8cad40-e985-442c-8351-e193a6c48f94.png)
...
![](./C生万物之文件操作.assets/1740109824170-380a65d5-41b8-4ca6-b697-c091aca84c83.png)
...
![](./C生万物之文件操作.assets/1740109827451-f889a65c-320a-4d81-a57e-39e45d70e652.png)
...
![](./C生万物之文件操作.assets/1740109828840-ad106049-6d93-4473-ae97-e42c8e097b78.png)
...
![](./C生万物之文件操作.assets/1740109830764-9c228b39-0509-4adc-b596-94923764b452.png)
...
![](./C生万物之文件操作.assets/1740109832174-ab732cdf-54a5-40b2-b66e-e79d626241ad.png)

```c
int sscanf ( const char * s, const char * format, ...);
```

![](./C生万物之文件操作.assets/1740109833419-d5fa4e0e-7017-43ad-8f8a-3d4467777367.png)
...
![](./C生万物之文件操作.assets/1740109835432-7daaa4b7-7a11-4335-96b1-178e6658d6fc.png)

+ 比如说前端给到用户一个收集信息的表单，用户输入数据之后呢，前端就将这些信息用“+”号做了一个拼接给到后端，后端呢为了要识别这些信息，一定会创建一个结构体，里面包含这些信息的，这个时候就可以使用到我们上面所说的【sscanf】以格式化的方式去读取这个字符串了，然后就可以解析出用户的这些数据，然后去进行一个处理了
...
![](./C生万物之文件操作.assets/1740109837447-94dd06c5-eb38-4aeb-b68e-f22e3be9a4f4.png)

+ 然后通过代码我们再来实现一下这个功能。首先看到是使用到了【SEEK_SET】从文件的起始位置开始偏移，因为文件的起始是从第一个字符开始，向后偏移三位就到了【d】的位置

![](./C生万物之文件操作.assets/1740109846087-6fc49c4d-78a2-407a-9b1e-2ede4d9aa2e2.png)  
![](./C生万物之文件操作.assets/1740109844724-39d7d542-2d24-48fc-b0ee-837f09cf4571.png)

+ 接下来我们再来看一种。刚才是从前往后偏移，现在则是从后往前偏移，那就要使用到【SEEK_END】

![](./C生万物之文件操作.assets/1740109851686-5f870d74-72b6-42d3-b797-568c4fc9a0db.png)

+ 最后一个是【SEEK_CUR】，也就是从当前位置向后偏移

![](./C生万物之文件操作.assets/1740109852936-dbc67e09-8855-4f2f-bf20-e94a4ae2cf23.png)
...
![](./C生万物之文件操作.assets/1740109854283-55b15e3d-2a8a-4d09-9b35-5849b4309b8f.png)
...
![](./C生万物之文件操作.assets/1740109856271-00e6bddd-44f5-41ec-8ad0-e7d0fa93be0c.png)

+ 这个很简单，就是返回当前文件指针所在流中的位置

![](./C生万物之文件操作.assets/1740109857862-fe037bc0-031a-4d56-8874-8da65b778d1d.png)  
补充一个实际案例
...
![](./C生万物之文件操作.assets/1740109859702-72a8bf68-de52-4823-8f12-b24fe629f552.png)
...
![](./C生万物之文件操作.assets/1740109861649-28ea54fb-c12d-4e29-96cf-ad07516479cb.png)

+ 可以看到，我们又读到了a，表明文件指针pf确实回到到了起始位置

![](./C生万物之文件操作.assets/1740109862968-bc7c4124-8ed5-48e8-ac2a-15b47f2461e5.png)
...
![](./C生万物之文件操作.assets/1740109865167-f5a4b6a3-995b-4777-9273-cc39a2e7b0b0.png)
...
![](./C生万物之文件操作.assets/1740109866605-db4ed7e0-177b-4f3e-aace-58b619afd5c5.png)
...
![](./C生万物之文件操作.assets/1740109868749-86af470a-cb91-4e23-b5de-d14cc70e940d.png)

![](./C生万物之文件操作.assets/1740109870161-dc8a7211-c38b-4d4a-91fd-63cfb3a3cebf.png)
...
从中我们可以知晓【feof】应用于当文件读取结束的时候，判断是**读取失败**结束，还是**遇到文件尾**结束  ![](./C生万物之文件操作.assets/1740109872054-c19ef8b3-accb-44c5-9d9b-746842b03280.png)
...
![](./C生万物之文件操作.assets/1740109878142-723443e4-f01d-4439-a924-90fe2f943b2f.png)
...
![](./C生万物之文件操作.assets/1740109880120-eba5d962-8379-4deb-91ac-ec612af69551.png)
...
![](./C生万物之文件操作.assets/1740109883609-1150c305-202b-42de-b6d0-686cafcb6ca1.png)
...
![](./C生万物之文件操作.assets/1740109885162-9c8b05db-98a3-4fb7-b480-2260485b2d7a.png)
...
下面是有关文件缓冲区的示意图  
![](./C生万物之文件操作.assets/1740109890475-371be1c3-a07f-4547-97e5-6d3fdd427c2a.png)
...
### 2、思路解析
![](./C生万物之文件操作.assets/1740109916513-520ac61c-dddf-4ff4-ac94-496047b13a8d.png)
...
![](./C生万物之文件操作.assets/1740109918736-952b1898-f184-4bc0-8f17-d51c9d33a138.png)
...
![](./C生万物之文件操作.assets/1740109925025-c19d2e01-6278-4915-a06f-be38e8afed8b.png)
...
![](./C生万物之文件操作.assets/1740109931556-06ba56dc-afa0-4e80-81d9-c25802cbd551.png)  
 ![](./C生万物之文件操作.assets/1740109933768-1ce9c615-9665-4096-8727-13dbbbfda579.png)
...
![](./C生万物之文件操作.assets/1740109938082-117e4257-2b6b-4041-8a34-422dfc5e7cfd.png)
