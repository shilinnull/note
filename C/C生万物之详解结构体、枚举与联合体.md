...
### 3、特殊的声明
> 接下去我来介绍一种特殊的结构体声明形式，也就是【匿名结构体】，也就是**没有结构体名称**
>
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106305985-88080a3f-f2c0-493d-a7ae-7f02580c737c.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106316491-d5b98171-a292-4a38-8d72-7efc9d0e93ad.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106317595-4f33a149-cb21-4f2a-9727-3f37180af16b.png)

+ 其实对于链表的单个结点来说，是由两个域组成的，一个叫做【数据域】，是存放结点数据的，一个叫做【指针域】，是存放下一个结点在堆内存中地址，图示如下：

![](./C生万物之详解结构体、枚举与联合体.assets/1740106319682-62bab4be-a2bd-4292-bde4-0f6412483168.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106319875-d980d73a-22bb-446d-8b68-148edb4d812f.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106326165-aad27b1e-0a75-45fd-ac30-d3a29c782500.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106352820-88e2a471-0590-4c10-a7d4-63e278ff3138.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106354741-c730dbf3-e3c2-4f56-87d3-c02e1087955c.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106357378-88436a3d-c74b-412f-88dc-069e72d29ca6.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106361295-4a63bdb6-ebc1-44ae-ba57-b29b81cf58be.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106362351-9246f17f-9e4c-46d6-90f6-0334d5aa88db.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106364429-373633a4-9b06-4faa-8d4d-bfe2b6d01fcc.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106366104-f64b38d3-aa78-40ff-90d6-6d2b651a9ddd.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106372154-1fef0a6b-12c8-4bbc-8a40-451b75c8eae3.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106373441-c1cc5a6e-628c-4d23-8143-1a8f5ac483b7.png)

首先还是一样，`c1`放在这个与结构体变量偏移量为0的地址处，而且它的类型还是`char`，所以只占1个内存单元  
![](./C生万物之详解结构体、枚举与联合体.assets/1740106375369-2c8d911d-0e24-4e0e-b29a-c70f9b0dd856.png)

+ 接下去还是一样，在放置第二个成员变量开始就要考虑【对齐数】了，`char`所占的字节为1B，与8去进行比较一下就可以知道1来得小，那我们直接放在偏移处为1的地方就可以了，此时在内存中也只占了2个字节

![](./C生万物之详解结构体、枚举与联合体.assets/1740109296583-c8616043-c25b-4849-a8de-8a78e3590aaa.png)

+ 接下去放置第三个成员变量【i】，大小为4个字节小于8因此选择在4的**整数倍的地址处**开始放置这个变量，整型占4个字节，所以一直占用到偏移量为7的地方
+ 接下去就是计算整个结构体的大小，**最大对齐数**为4，所以要为4的整数倍，此时去计算一下得知从0 ~ 7偏移了7个字节，占用了8个空间，刚好为4的整数倍，所以结构体S2的大小为【8】是这么算出来的

![](./C生万物之详解结构体、枚举与联合体.assets/1740109312267-43710c09-fdd0-465e-84ba-61293cdd2b31.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109324121-10edbe6b-0768-44be-b084-c9c69880e35a.png)

对于第二个成员变量【c】，类型为`char`，所以在内存中占用1个字节，那直接放在偏移量为8的地址处即可  
![](./C生万物之详解结构体、枚举与联合体.assets/1740106698604-44e64472-0aeb-4b19-99f3-447e811fe62a.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740106695697-ccee8bee-d37c-4ba6-972d-2a2006ba79ec.png)

**运行结果如下：**

![](./C生万物之详解结构体、枚举与联合体.assets/1740106693765-653441b2-e10d-4550-b62d-868212354309.png)

**也可以通过【offsetof】来验证一下**

![](./C生万物之详解结构体、枚举与联合体.assets/1740109333407-fa246f47-668f-411e-a1fc-df2c289d22c4.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109335175-7bd5d035-4497-4da0-963f-2594feff7209.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109338614-867f1960-96b0-406d-8b72-3851e9c9d4b5.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109340025-0a0f120b-a7b8-4a18-aef8-9d7ae0899681.png)

**运行结果如下：**

![](./C生万物之详解结构体、枚举与联合体.assets/1740109343399-4d8b5dba-b720-4f5e-8020-7155ee60d58c.png)

**可以通过【offsetof】再来验证一下**

![](./C生万物之详解结构体、枚举与联合体.assets/1740109342478-52c85dd1-1bc3-4a89-8b39-b038fe296f77.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109345439-5f07b6c5-1191-45fd-af9c-7c0caa8d9814.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109348409-e6fc152a-8e06-4ed3-9ab8-a7405443f004.png)

**运行结果如下：**

![](./C生万物之详解结构体、枚举与联合体.assets/1740109349732-8832ef1f-0733-4edd-907e-e3f248ee9e58.png)

**可以通过【offsetof】再来验证一下**

![](./C生万物之详解结构体、枚举与联合体.assets/1740109351066-dd1c9705-86f1-41ee-897f-cf8785aeded2.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109352395-c7ea9a2b-9141-44b7-ad4c-70071c76ead1.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109361275-07edc287-dfc8-402a-8cbe-ea0ed05524c3.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109365323-1354917a-2817-4990-a487-defb7f32a110.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109368281-662fb13f-f463-44e0-8328-01cc22236332.png)
...
空间是如何开辟的？  
![](./C生万物之详解结构体、枚举与联合体.assets/1740109370855-8e435685-223f-44c0-98ce-3f944e1ffb64.png)
...
### 5. 位段在网络传输中的应用
![](./C生万物之详解结构体、枚举与联合体.assets/1740109373632-e87924d8-5aa0-4e7c-84a9-29d823bcd61a.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109375958-c8317cb8-cadf-4d4f-baa6-c1a9f98786b3.png)

+ 虽然说这个常量是不可改变的，但是对于一个常量在一开始也是需要有一个值，即我们所说的【初始值】，对于定义在枚举内部的常量，是存在初始值的，**默认从0开始，依次递增1**
+ 我们可以去打印来观察一下是否存在上面这样的规律💻

![](./C生万物之详解结构体、枚举与联合体.assets/1740109377439-3728e243-7c60-41b6-9c95-9fe43218a401.png)

+ 当然，我们也可以自己去做赋值

![](./C生万物之详解结构体、枚举与联合体.assets/1740109378864-f678412c-79a6-4b7a-a5a3-159762295c23.png)

+ 除此之外，枚举内部的这个值是**会自动增长的**，假如我们给RED设了一个初始值为3，那么GREEN和BLUE的初始值便会去进行一个自动的增长的，如下所示↓

![](./C生万物之详解结构体、枚举与联合体.assets/1740109380271-a7a0419e-0d43-4e54-b026-33036de323d5.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109382406-81fd47fc-9f22-49fe-9714-60203b1303a8.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109385464-3d7938d0-b004-48a1-8b22-56c8c8a77f2f.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109386722-f7808f77-80d6-4f98-abb3-d1fc33af883a.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109388799-cced216f-7e43-4e89-abdc-27001c62739e.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109390603-418334b7-facd-47f7-9323-35775c8ab7e7.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109392965-90bb5058-6de3-4bf7-b807-d5cea0dc5458.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109395872-97a1a15e-b6bd-439a-b400-a5d203a83df6.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109397276-1e5f1df5-1355-4dfe-8f59-29ce73a6f27d.png)
...
![](./C生万物之详解结构体、枚举与联合体.assets/1740109404241-745b8e5d-5a9a-4f6e-8956-bd5400f7c5c2.png)

+ 那么此时联合体中的成员c便为`0x00EFF99C`这块地址上的第一个字节即`01`，这个时候我们去`return un.c`的时候就是把这个`01`给返回回去了，使用int整型来接受即为1，所以最后打印的结果就是【小端】

![](./C生万物之详解结构体、枚举与联合体.assets/1740109405608-aabe2049-f1a9-4672-84e9-845642be32e8.png)
